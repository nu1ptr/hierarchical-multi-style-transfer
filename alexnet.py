...
class AlexNet:
    ...
    def __init__(self, sess):
        ...
        net_data = load(open(alexnet_dir + "bvlc_alexnet.npy", "rb"), encoding="latin1").item()
        print('Finished loading AlexNet')
        ...
        print('Total Number of Convolutional Tensors: %d' % len(self.layer_tensors))
        return
